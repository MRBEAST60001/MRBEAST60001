...
\begin{tikzpicture}
\begin{axis}[
  width=0.64\textwidth, height=0.33\textwidth,
...
\draw[<->,thin] (axis cs:5.22,2.1) -- (axis cs:5.22,3.5) node[midway,right,font=\small,align=left] {gap predicted\\by the priors};
\draw[<->,thin] (axis cs:5.22,0.6) -- (axis cs:5.22,2.1) node[midway,right,font=\small,align=left] {excess $U\neq 0$};
\end{axis}
\end{tikzpicture}
