...
\begin{tabular}{@{}l >{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{2.9cm} c c >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{3.5cm}@{}}
\toprule
...
\label{tab:plan}
\begin{tabular}{@{}l >{\raggedright\arraybackslash}p{7.4cm} l l@{}}
\toprule
