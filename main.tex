...
\vspace{1.45em}
{\fontsize{11}{14}\selectfont\textls[28]{Tanmay Goswami, Yibo Yang, Asra Asif, Sourayan Deysarkar}\par}
\vspace{0.42em}
{\small\color{muted}Algoverse AI Research\par}
\vspace{0.3em}
{\footnotesize\itshape\color{muted}\textls[45]{Research proposal}\par}
\end{center}
\vspace{1.0em}
\begin{center}
